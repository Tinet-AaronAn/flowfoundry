...
class AiCollectionActivityRouterTest {
  ...
  private static class FakeActivities implements CallCampaignActivities {
    ...
    @Override
    public com.tinet.flowfoundry.demo.aicollection.model.FilterSplitResult filterAndSplitBatches(
        String campaignId) {
      return null;
    }

    @Override
    public com.tinet.flowfoundry.demo.aicollection.model.NotifyOwnerResult notifyOwnerReport(
    ...
    @Override
    public com.tinet.flowfoundry.demo.aicollection.model.PrepareRoundResult prepareCallRound(
    ...
    @Override
    public com.tinet.flowfoundry.demo.aicollection.model.AggregateRoundResult aggregateRoundResults(
        String campaignId, int roundNumber) {
      return null;
    }

    @Override
    public com.tinet.flowfoundry.demo.aicollection.model.StartAiTaggingResult startAiTagging(
    ...
    @Override
    public com.tinet.flowfoundry.demo.aicollection.model.FinalizeCampaignResult finalizeCampaign(
